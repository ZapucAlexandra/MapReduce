...
/**
 * Clasa ce implementeaza un "MAP work pool" conform modelului "replicated workers".
 * Task-urile introduse in work pool sunt obiecte de tipul MapTask.
 *
 */
public class WorkPool {
	...
	/**
	 * Functie care incearca obtinera unui task din mapworkpool.
	 ...
	 */
	synchronized void putWork(Task task) {
		tasks.add(task);
